...
export class Dictation{
    ...
    constructor(apiTokenElement:HTMLInputElement,toggleButton:HTMLButtonElement,abortButton:HTMLButtonElement,startSoundElement:HTMLAudioElement,onFinishedDictationCallback:onTranscriptionReceivedCallback){
