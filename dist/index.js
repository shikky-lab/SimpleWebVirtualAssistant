...
const adjustMiddleContentHeight = () => {
    ...
    const bottomContentHeight = document.getElementById("bottom-content").offsetHeight;
    const availableHeight = window.innerHeight - topContentHeight - bottomContentHeight;
